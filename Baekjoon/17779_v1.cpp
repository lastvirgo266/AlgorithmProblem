...
void DFS(){
    for(int temp_d1=1; temp_d1<=N; temp_d1++){
        for(int temp_d2=1; temp_d2<=N; temp_d2++){
            for(int temp_y=1; temp_y<temp_d1+temp_d2+temp_y && temp_d1+temp_d2+temp_y<=N; temp_y++){
                for(int temp_x= 2; temp_x-temp_d1 < temp_x && temp_x < temp_x+temp_d2 && 
                     temp_x + temp_d2<=N; temp_x++ ){
                    y = temp_y;
                    x = temp_x;
                    d1 = temp_d1;
                    d2 = temp_d2;
