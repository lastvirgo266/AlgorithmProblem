        ...
        if((0<= new_y && new_y <N &&
           ...
           0> new_y || new_y >=N || 0> new_x || new_x >= N){
            ...
            for(int i=0; i<group.size(); i++){
                ...
                new_direction[0] = group[i].direction[0];
                new_direction[1] =  group[i].direction[1];

            }

            int blue_y = temp.y + group[0].direction[0];
            int blue_x = temp.x + group[0].direction[1];

            //Test
            printf("%d %d %d %d\n",blue_y, blue_x, new_direction[0], new_direction[1]);
